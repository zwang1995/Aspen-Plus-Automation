...
class Aspen_Plus_Interface():
    ...
    def load_file(self, file, visible_state=0, dialog_state=0):
        """
        Load a process flowsheet via bkp or apw file
        :param file: location of the Aspen Plus file
        ...
        """
        self.Application.InitFromArchive2(os.path.abspath(file))
